...
impl ImplementationResult {
    pub fn new(nth_term: u128, n: u64, time: u64) -> ImplementationResult {
        return ImplementationResult { nth_term, n, time };
    }

    pub fn to_string(&self) -> String {
        return format! {"The {}th term of the Fibonacci sequence is {}. It took {} miliseconds to calculate it.", self.n, self.nth_term, self.time};
    }
}
