...
pub enum FibonacciError {
    #[error("We could not calculate the fibonnaci sequence because the value[s] provided were not whole number[s] greater than zero or equal to.")]
    UserInputError,
    #[error(
...
By default, the limit is 1073741824 recursive calls."
    )]
